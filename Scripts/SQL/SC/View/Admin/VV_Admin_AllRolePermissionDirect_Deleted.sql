/****** Object:  View [stng].[VV_Admin_AllRolePermissionDirect_Deleted]    Script Date: 10/21/2024 12:38:11 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE view [stng].[VV_Admin_AllRolePermissionDirect_Deleted] as
with directroles as
(
...
(
	select a.RoleID, a.[Role], b.PermissionID, c.Permission
...
select RoleID, [Role], PermissionID, Permission
