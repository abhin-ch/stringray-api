/****** Object:  View [stng].[VV_Admin_UserAttribute_Deleted]    Script Date: 10/21/2024 12:34:14 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE view [stng].[VV_Admin_UserAttribute_Deleted] as
with attributes as
(
	select a.UniqueID as AttributeID, a.Attribute, b.UniqueID as AttributeTypeID, b.AttributeType, b.Supersedence
	from stng.Admin_Attribute as a
	inner join stng.Admin_AttributeType as b on a.AttributeType = b.UniqueID and b.Deleted = 0
	where a.Deleted = 0
)

select a.UniqueID, b.EmployeeID, c.Attribute, c.AttributeID,
...
inner join stng.Admin_User as b on a.EmployeeID = b.EmployeeID
